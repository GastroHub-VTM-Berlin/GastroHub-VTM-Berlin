...
$('.mailchimp').ajaxChimp({
    ...
    url: "//gastrohub.us12.list-manage.com/subscribe/post?u=0836fae3f999a0776f7e3141f&amp;id=d5c0b6ea0f" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".
});
...
$("#contact").submit(function (e) {
    ...
    if (isValidEmail(email) && (message.length > 1) && (name.length > 1)) {
        $.ajax({
            type: "POST",
            url: "//formspree.io/info@gastrohub.de",
						dataType:"json",
